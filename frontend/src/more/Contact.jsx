            ...
            <div className="contact-info">
              ...
              <div className="bicfs">
                ...
                <div className="social-icons">
                  ...
                  <Link to="/" className="bicf linkedin">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
